      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-in">
          ...
          <div class="col-lg-12 mt-12  ">
            ...
            <form method="POST" action="{{url('/alumnos/crear_guardar')}}"   >
                        @csrf

                        <div class="form-group row"> 
                            <div class="col-md-4">
                            <label for="name" class=" col-form-label text-md-right">{{ __('Código del alumno') }}</label>
                                <input id="codigo" type="text" class="form-control @error('codigo') is-invalid @enderror" name="codigo" value="{{ old('codigo') }}" required autocomplete="curso" autofocus>
